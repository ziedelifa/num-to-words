...
namespace NumToWords\Legacy\Numbers\Words\Locale\Pt;
...
class Br extends Words
{
    ...
    protected function toWords($num)
    {
        ...
        foreach ($chunks as $index => $chunk) {
            ...
            if (!array_key_exists($index, self::$exponent)) {
                throw new NumToWordsException('Number out of range.');
            }
    ...
    public function toCurrencyWords($currency, $decimal, $fraction = null)
    {
        ...
        if ($fraction) {
            ...
            if ($num < 0 || $num > 99) {
                throw new NumToWordsException('Fraction out of range.');
            }
